...
if(isset($_SESSION["Ssn"]) ){
    ...
    $sql = "SELECT Dependent_name, Sex, Bdate, Relationship, Active, Dependent_id FROM DEPENDENT_EC WHERE Essn=?";
			...
			if(mysqli_num_rows($result) > 0){
				...
				// output data of each row
                    while($row = mysqli_fetch_array($result)){
                        ...
                        echo "<td>" . $row['Dependent_id'] . "</td>";

						echo "<td>";

                            echo "<a href='updateDependent.php?Dependent_id=". $row['Dependent_id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                            echo "<a href='deleteDependent.php?Dependent_id=". $row['Dependent_id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                        echo "</td>";
